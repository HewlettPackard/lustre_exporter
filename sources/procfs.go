...
func (s *lustreSource) generateMDTMetricTemplates() error {
	metricMap := map[string][]lustreHelpStruct{
		"mdt/*": {
			...
			{"md_stats", "mdt_mknod", mknodHelp, s.counterMetric},
			{"md_stats", "mdt_link", linkHelp, s.counterMetric},
			{"md_stats", "mdt_unlink", unlinkHelp, s.counterMetric},
			{"md_stats", "mdt_mkdir", mkdirHelp, s.counterMetric},
			{"md_stats", "mdt_rmdir", rmdirHelp, s.counterMetric},
			{"md_stats", "mdt_rename", renameHelp, s.counterMetric},
			{"md_stats", "mdt_sync", syncHelp, s.counterMetric},
			{"md_stats", "mdt_samedir_rename", samedirRenameHelp, s.counterMetric},
			{"md_stats", "mdt_crossdir_rename", crossdirRenameHelp, s.counterMetric},
			{"num_exports", "num_exports", "Total number of times the pool has been exported", s.counterMetric},
